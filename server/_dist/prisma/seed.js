...
async function main() {
    ...
    const mergedBank = { ...questionBank, ...questionBankExtra };
    for (const t of allTopicDefs) {
    ...
    console.log("Seed OK:", {
        ...
        classMap: "Class 6 (A) -> Basic Mathematics (Levels 0, 1, 2) and Class 7 (A) -> Basic Mathematics (Level 0) loaded",
    });
}
main()
    .catch((e) => {
